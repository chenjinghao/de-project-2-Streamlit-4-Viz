...
st.page_link("https://public.tableau.com/views/TickersAnalysisDashboard/Dashboard?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link", label="Tableau Version", icon=":material:table_chart:")
st.page_link("https://github.com/chenjinghao/ms_fabric_project", label="Microsoft Fabric & Power BI Version", icon=":material:table_chart:")
# Getting data
